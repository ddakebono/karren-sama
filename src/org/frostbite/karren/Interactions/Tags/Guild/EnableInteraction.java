...
public class EnableInteraction extends Tag {
    ...
    public String handleTemplate(String msg, Interaction interaction, InteractionResult result) {
        ...
        if (parameter != null) {
            ...
            for (Interaction enable : Karren.bot.getGuildManager().getInteractionProcessor(guild).getInteractions().stream().filter((p) -> p.getIdentifier().equalsIgnoreCase(parameter)).collect(Collectors.toList())) {
